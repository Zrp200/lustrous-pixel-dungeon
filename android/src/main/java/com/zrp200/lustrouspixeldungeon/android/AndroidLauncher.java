...
public class AndroidLauncher extends AndroidApplication {
	...
	protected void onCreate (Bundle savedInstanceState) {
		...
		LustSettings.setPrefsFromInstance(instance);
		
		//set desired orientation (if it exists) before initializing the app.
		if (LustSettings.landscapeFromSettings() != null) {
			if (LustSettings.landscapeFromSettings()){
		...
		initialize(new LustrousPixelDungeon(support), config);
